...
file_address_annexe <- here("Data/processed" , "Annexe_Merged_Geodataset.csv")
```
...
```{r}
Taxize_filtered_df <- read.csv(file.path("..", "Data/processed", "02_Taxize_filtered_df.csv"))
...
### Handmade check
```{r}
Handmade_filtered_df <- read.csv(file.path("..", "Data/processed", "04_Handmade_filtered_df.csv")) %>%
...
```{r}
shp_file_path <- file.path("..", "Data/external", "shp_pf")
```
