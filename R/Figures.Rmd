...
my_color <- 'd3.scaleOrdinal() .domain(["a", "b", "c","d", "e", "f", "g", "h", "i", "j", "k", "l","m","n","a1", "b1", "c1","d1", "e1", "f1", "g1", "h1", "i1", "j1", "k1", "l1","m1"]) .range(["#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7", "#A093C7",
"#D4E6F1", "#F39C12", "#A9CCE3", "#F39C12", "#7FB3D5", "#F39C12", "#F39C12", "#5499C7", "#2980B9", "#F39C12", "#2471A3", "#2471A3", "#F39C12"
])'
...
p <- networkD3::sankeyNetwork(Links = links, Nodes = nodes, 
                   ...
                   fontSize = 15, fontFamily = 10, sinksRight = FALSE, 
...
# save the widget
# library(htmlwidgets)
htmlwidgets::saveWidget(p, file= "C:/Users/MG/Documents/GitHub/biogeography_datadiv/Data/Other/sampbias/sankeyBasic1.html")

library(webshot)
webshot("C:/Users/MG/Documents/GitHub/biogeography_datadiv/Data/Other/sampbias/sankeyBasic1.html", "C:/Users/MG/Documents/GitHub/biogeography_datadiv/Data/Other/sampbias/sankey.png", vwidth = 1100, vheight = 150, cliprect = "viewport")
...
fig3_panelB <- function(dataset, Habitat) {
  ...
  gg <- ggplot(data = dataset, aes(x = log10(n_species+1), y = archipelago, colour = archipelago)) +
...
b <- fig3_panelA(filtered_data, "Terrestrial", 0.5, shp) + theme(axis.title.y = element_blank(), axis.text.y = element_blank())

occurrences_mar <- fig3_panelB(filtered_data, "Marine")
occurrences_terr <- fig3_panelB(filtered_data, "Terrestrial") + 
