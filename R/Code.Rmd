...
```{r}
shp_file_path <- file.path("..", "Data/Other", "shp_pf")
```
...
filtered_data <- filtered_data %>%
  dplyr::mutate(isMarine = ifelse(isMarine == 0, NA, isMarine),
...
#write.csv2(filtered_data, file = "05_Filtered_data.csv", row.names = FALSE)
```
